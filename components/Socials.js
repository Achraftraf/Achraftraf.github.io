...
const Socials = () => {
  return <div className="flex items-center gap-x-5 text-lg">
    ...
    <Link href={'https://github.com/Achraftraf/Achraftraf.github.io'} className='hover:text-accent transition-all duration-300'><RiGithubLine /></Link>
    ...
    <Link href={''} className='hover:text-accent transition-all duration-300'><RiMailLine /></Link>
