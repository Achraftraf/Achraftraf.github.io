...
initial="hidden" animate="show" exit="hidden" transition={{duration: 1,ease: 'easeInOut'}} className='w-full h-full max-w-[737px] max-h-[678px] absolute  -bottom-30 lg:bottom-300 lg:right-[5%]'>
      <Avatar />
    </motion.div>
    </div>  
    </div>
